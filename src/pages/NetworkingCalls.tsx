...
const FridayNetworkingCTA = () => (
	<div className="w-full flex justify-center mt-4">
		<div className="bg-yellow-50 dark:bg-yellow-900 rounded-xl px-6 py-6 text-center shadow max-w-lg w-full">
			...
			<a
				href="https://forms.gle/td9DkMsKwc1V34TK8"
				target="_blank"
				rel="noopener noreferrer"
				className="bg-yellow-400 text-black dark:bg-electric-yellow dark:text-black font-bold px-6 py-2 rounded-full shadow hover:bg-yellow-300 dark:hover:bg-yellow-300 transition-colors inline-block"
			>
				🔗 Join the Community
			</a>
		</div>
